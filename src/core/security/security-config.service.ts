...
export class SecurityConfigService {
  ...
  constructor(private readonly configService: ConfigService) {
    console.log(
      '🔐 SecurityConfigService: Initializing security configuration...',
    );
    ...
    try {
      ...
      console.log(
        '✅ SecurityConfigService: Security configuration created successfully',
      );
    } catch (error) {
      console.error(
        '❌ SecurityConfigService: Error creating security configuration:',
        error,
      );
      throw error;
    }
  ...
  getHelmetConfig() {
    ...
    console.log(
      '🔧 SecurityConfigService: Helmet config:',
      JSON.stringify(helmetConfig, null, 2),
    );
    return helmetConfig;
  }
  ...
  getCorsConfig() {
    ...
    console.log(
      '🔧 SecurityConfigService: CORS config:',
